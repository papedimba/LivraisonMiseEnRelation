...
-- ----------------------------------------------------------------------------
-- Marchandage du prix entre client et livreur (une ligne evolutive par
-- paire commande/livreur ; propose_par + montant_propose changent a chaque
-- tour, jusqu'a acceptation ou refus).
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Cartographie collaborative : points de repere contribues par les usagers
-- ----------------------------------------------------------------------------

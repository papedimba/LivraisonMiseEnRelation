...
$pageTitle = 'Historique de mes courses';
...
<div class="card">
    <div class="table-wrap">
        <table>
            <thead>
                <tr><th>Reference</th><th>Type</th><th>Statut</th><th>Montant</th><th>Date</th></tr>
            </thead>
...
(async function () {
    ...
    try {
        ...
        if (commandes.length === 0) {
            tbody.innerHTML = '<tr><td colspan="5" class="text-muted">Aucune course pour le moment.</td></tr>';
            return;
        }
